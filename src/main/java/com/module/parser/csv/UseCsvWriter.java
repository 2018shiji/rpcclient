...
public class UseCsvWriter {
    ...
    private static CellProcessor[] getProcessors(){
        final CellProcessor[] processors = new CellProcessor[]{
                ...
                new FmtDate("dd/MM/yyyy"), // birthDate 日期的格式// mailingAddress
    ...
    public static void writeWithCsvBeanWriter() throws Exception {
        ...
        try{
            beanWriter = new org.supercsv.io.CsvBeanWriter(new FileWriter("D:\\log\\writeWithCsvBeanWriter.csv"),
            ...
            beanWriter.writeHeader(header);//写入表头
            for(final CustomerBean customer : customers){
                beanWriter.write(customer, header, processors);//写入数据
            }
        } finally{
